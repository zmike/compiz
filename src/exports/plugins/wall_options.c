...
int
wallGetPreviewScale(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetPreviewScaleOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetPreviewScaleNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
int
wallGetBorderWidth(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetBorderWidthOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetBorderWidthNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
Bool
wallGetAllowWraparound(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetAllowWraparoundOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetAllowWraparoundNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompMatch *
wallGetNoSlideMatch(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetNoSlideMatchOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetNoSlideMatchNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetLeftKeyInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetLeftKeyTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetLeftKeyOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetLeftKeyNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompAction *
wallGetLeftButton(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetLeftButtonInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetLeftButtonTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetLeftButtonOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetLeftButtonNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetRightKeyInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetRightKeyTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetRightKeyOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetRightKeyNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompAction *
wallGetRightButton(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetRightButtonInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetRightButtonTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetRightButtonOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetRightButtonNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetUpKeyInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetUpKeyTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetUpKeyOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetUpKeyNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetUpButtonInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetUpButtonTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetUpButtonOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetUpButtonNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetDownKeyInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetDownKeyTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetDownKeyOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetDownKeyNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompAction *
wallGetDownButton(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetDownButtonInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetDownButtonTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetDownButtonOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetDownButtonNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetNextKeyInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetNextKeyTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetNextKeyOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetNextKeyNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompAction *
wallGetNextButton(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetNextButtonInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetNextButtonTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetNextButtonOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetNextButtonNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetPrevKeyInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetPrevKeyTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetPrevKeyOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetPrevKeyNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompAction *
wallGetPrevButton(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetPrevButtonInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetPrevButtonTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetPrevButtonOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetPrevButtonNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompAction *
wallGetLeftWindowKey(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetLeftWindowKeyInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetLeftWindowKeyTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetLeftWindowKeyOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetLeftWindowKeyNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompAction *
wallGetRightWindowKey(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetRightWindowKeyInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetRightWindowKeyTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetRightWindowKeyOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetRightWindowKeyNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompAction *
wallGetUpWindowKey(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetUpWindowKeyInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetUpWindowKeyTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetUpWindowKeyOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetUpWindowKeyNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompAction *
wallGetDownWindowKey(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetDownWindowKeyInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetDownWindowKeyTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetDownWindowKeyOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetDownWindowKeyNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompAction *
wallGetFlipLeftEdge(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetFlipLeftEdgeInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetFlipLeftEdgeTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetFlipLeftEdgeOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetFlipLeftEdgeNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompAction *
wallGetFlipRightEdge(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetFlipRightEdgeInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetFlipRightEdgeTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetFlipRightEdgeOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetFlipRightEdgeNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompAction *
wallGetFlipUpEdge(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetFlipUpEdgeInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetFlipUpEdgeTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetFlipUpEdgeOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetFlipUpEdgeNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompAction *
wallGetFlipDownEdge(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetFlipDownEdgeInitiate(CompDisplay *d, CompActionCallBackProc init)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetFlipDownEdgeTerminate(CompDisplay *d, CompActionCallBackProc term)
{
   WALL_OPTIONS_DISPLAY(d);
...
CompOption *
wallGetFlipDownEdgeOption(CompDisplay *d)
{
   WALL_OPTIONS_DISPLAY(d);
...
void
wallSetFlipDownEdgeNotify(CompDisplay *d, wallDisplayOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_DISPLAY(d);
...
Bool
wallGetEdgeflipPointer(CompScreen *s)
{
   WALL_OPTIONS_SCREEN(s);
...
CompOption *
wallGetEdgeflipPointerOption(CompScreen *s)
{
   WALL_OPTIONS_SCREEN(s);
...
void
wallSetEdgeflipPointerNotify(CompScreen *s, wallScreenOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_SCREEN(s);
...
Bool
wallGetEdgeflipMove(CompScreen *s)
{
   WALL_OPTIONS_SCREEN(s);
...
CompOption *
wallGetEdgeflipMoveOption(CompScreen *s)
{
   WALL_OPTIONS_SCREEN(s);
...
void
wallSetEdgeflipMoveNotify(CompScreen *s, wallScreenOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_SCREEN(s);
...
Bool
wallGetEdgeflipDnd(CompScreen *s)
{
   WALL_OPTIONS_SCREEN(s);
...
CompOption *
wallGetEdgeflipDndOption(CompScreen *s)
{
   WALL_OPTIONS_SCREEN(s);
...
void
wallSetEdgeflipDndNotify(CompScreen *s, wallScreenOptionChangeNotifyProc notify)
{
   WALL_OPTIONS_SCREEN(s);
...
static Bool
wallOptionsSetDisplayOption(CompPlugin *plugin, CompDisplay *d, const char *name, CompOptionValue *value)
{
   WALL_OPTIONS_DISPLAY(d);
   CompOption *o;
   int index;
...
static Bool
wallOptionsSetScreenOption(CompPlugin *plugin, CompScreen *s, const char *name, CompOptionValue *value)
{
   WALL_OPTIONS_SCREEN(s);
   CompOption *o;
   int index;
...
static CompBool
wallOptionsInitObject(CompPlugin *p, CompObject *o)
{
...
static void
wallOptionsFiniObject(CompPlugin *p, CompObject *o)
{
...
static CompBool
wallOptionsInitObjectWrapper(CompPlugin *p, CompObject *o)
{
   CompBool rv = TRUE;
...
static void
wallOptionsFiniObjectWrapper(CompPlugin *p, CompObject *o)
{
...
static CompOption *
wallOptionsGetObjectOptions(CompPlugin *p, CompObject *o, int *count)
{
...
static CompBool
wallOptionsSetObjectOption(CompPlugin *p, CompObject *o, const char *name, CompOptionValue *value)
{
