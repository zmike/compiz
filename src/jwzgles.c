...
glNewList (int id, int mode)
{
  ...
  if (L->count != 0) glDeleteLists (L->id, 1); /* Overwriting */
...
# ifdef DEBUG
  ...
  case PROTO_VOID:
    ...
    break;
  case PROTO_I:
    if (fn == (list_fn_cb) &glBegin ||
        fn == (list_fn_cb) &glFrontFace ||
        fn == (list_fn_cb) &glEnable ||
        fn == (list_fn_cb) &glDisable ||
        fn == (list_fn_cb) &glEnableClientState ||
        fn == (list_fn_cb) &glDisableClientState ||
        fn == (list_fn_cb) &glShadeModel ||
        fn == (list_fn_cb) &glMatrixMode)
  ...
  case PROTO_F:
    ...
    break;
  case PROTO_II:
    if (fn == (list_fn_cb) &glBindTexture ||
        fn == (list_fn_cb) &glBindBuffer)
  ...
  case PROTO_III:
  case PROTO_ARRAYS:
    if (fn == (list_fn_cb) &glDrawArrays ||
        fn == (list_fn_cb) &glTexParameteri)
...
void
glDeleteLists (int id0, int range)
{
  ...
  if (state->compiling_list)
    {
      ...
      vv[0].i = id0;
      vv[1].i = range;
      list_push ("glDeleteLists", (list_fn_cb) &glDeleteLists, 
                 PROTO_II, vv);
    }
  else
    {
  ...
  if (state->compiling_list && !state->compiling_verts)
    {
      ...
      vv[1].f = v[1];
      vv[2].f = v[2];
      list_push ("glNormal3f", (list_fn_cb) &glNormal3f, 
                 PROTO_FFF, vv);
    }
  else
    {
  ...
  if (state->compiling_list && !state->compiling_verts)
    {
      ...
      vv[2].f = v[2];
      vv[3].f = v[3];
      list_push ("glTexCoord4f", (list_fn_cb) &glTexCoord4f,
                 PROTO_FFFF, vv);
    }
  else
    {
  ...
  if (state->compiling_list && !state->compiling_verts)
    {
      ...
      vv[2].f = v[2];
      vv[3].f = v[3];
      list_push ("glColor4f", (list_fn_cb) &glColor4f, 
                 PROTO_FFFF, vv);
    }
  else
    {
...
glColor4i (GLint r, GLint g, GLint b, GLint a)
{
  ...
  glColor4f (0.5 + (GLfloat) r / 0xFFFFFFFF,
...
glColor4ui (GLuint r, GLuint g, GLuint b, GLuint a)
{
  ...
  glColor4f ((GLfloat) r / 0xFFFFFFFF,
...
glColor4s (GLshort r, GLshort g, GLshort b, GLshort a)
{
  ...
  glColor4f (0.5 + (GLfloat) r / 0xFFFF,
...
void
glMaterialfv (GLenum face, GLenum pname, const GLfloat *color)
{
  ...
  if (state->compiling_verts)
  ...
  else if (state->compiling_list)
    {
      ...
      vv[4].f = color[2];
      vv[5].f = color[3];
      list_push ("glMaterialfv", (list_fn_cb) &glMaterialfv, 
                 PROTO_IIFV, vv);
    }
  else
    {
...
void
glMaterialiv (GLenum face, GLenum pname, const GLint *v)
{
  GLfloat vv[4];
  vv[0] = v[0];
  vv[1] = v[1];
...
void
glMaterialf (GLenum face, GLenum pname, const GLfloat c)
{
  GLfloat vv[4];
  vv[0] = c;
  vv[1] = c;
...
void
glMateriali (GLenum face, GLenum pname, const GLuint c)
{
  glMaterialf (face, pname, c);
}
  ...
  if (state->compiling_list)
    {
      ...
      vv[0].i = face;
      vv[1].i = mode;
      list_push ("glColorMaterial", (list_fn_cb) &glColorMaterial, 
                 PROTO_II, vv);
    }
  else
    {
  ...
  if (state->compiling_list)
    {
      ...
      vv[0].i = face;
      vv[1].i = mode;
      list_push ("glPolygonMode", (list_fn_cb) &glPolygonMode, 
                 PROTO_II, vv);
    }
  else
    {
  ...
  if (state->compiling_list)
    {
      void_int vv[1];
      vv[0].i = buf;
      list_push ("glDrawBuffer", (list_fn_cb) &glDrawBuffer, 
                 PROTO_I, vv);
    }
  else
    {
...
glEnd (void)
{
  ...
  */
  was_norm  = glIsEnabled (GL_NORMAL_ARRAY);
  was_tex   = glIsEnabled (GL_TEXTURE_COORD_ARRAY);
  was_color = glIsEnabled (GL_COLOR_ARRAY);
  was_mat   = glIsEnabled (GL_COLOR_MATERIAL);
  ...
  if (s->ncount > 1)
  ...
  else
    {
      is_norm = 0;
      if (s->ncount == 1)
        glNormal3f (s->cnorm.x, s->cnorm.y, s->cnorm.z);
  ...
  if (s->tcount > 1)
  ...
  else
    {
      is_tex = 0;
      if (s->tcount == 1)
        glTexCoord4f (s->ctex.s, s->ctex.t, s->ctex.r, s->ctex.q);
  ...
  if (s->ccount > 1)
  ...
  else
    {
      is_color = 0;
      if (s->ccount == 1)
        glColor4f (s->ccolor.r, s->ccolor.g, s->ccolor.b, s->ccolor.a);
   ...
   */
  if (s->materialistic && !glIsEnabled (GL_COLOR_MATERIAL))
    {
      is_mat = 1;
      glEnable (GL_COLOR_MATERIAL);
    }
...
# define RESET(VAR,FN,ARG) do { \
         if (is_##VAR != was_##VAR) { \
            if (was_##VAR) glEnable##FN (ARG); \
            else glDisable##FN (ARG); \
         }} while(0)
  ...
  if (state->compiling_list)
    {
      ...
      void_int vv[1];
      vv[0].i = id;
      list_push ("glCallList", (list_fn_cb) &glCallList, PROTO_I, vv);
    }
  else
    {
      list *L;
...
void
glDrawArrays (GLuint mode, GLuint first, GLuint count)
{
  if (state->compiling_list)
    {
      void_int vv[3];
      ...
      vv[1].i = first;
      vv[2].i = count;
      list_push ("glDrawArrays", (list_fn_cb) &glDrawArrays,
                 PROTO_ARRAYS, vv);
    }
  else
    {
...
void
glInterleavedArrays (GLenum format, GLsizei stride, const void *data)
{
...
void
glEnableClientState (GLuint cap)
{
  if (state->compiling_list)
    {
      void_int vv[1];
      ...
      list_push ("glEnableClientState", 
                 (list_fn_cb) &glEnableClientState,
                 PROTO_I, vv);
    }
  else
    {
...
void
glDisableClientState (GLuint cap)
{
  if (state->compiling_list)
    {
      void_int vv[1];
      ...
      list_push ("glDisableClientState", 
                 (list_fn_cb) &glDisableClientState,
                 PROTO_I, vv);
    }
  else
    {
  ...
  if (state->compiling_list)
    {
      ...
      for (i = 0; i < countof(vv); i++)
        vv[i].f = m[i];
      list_push ("glMultMatrixf", (list_fn_cb) &glMultMatrixf,
                 PROTO_FV16, vv);
    }
  else
    {
...
void
glSelectBuffer (GLsizei size, GLuint *buf)
{
...
void
glGenTextures (GLuint n, GLuint *ret)
{
  Assert (!state->compiling_verts,
                      ...
                      const GLvoid *data)
{
  ...
  glTexImage2D (target, level, internalFormat, width, 1,
  ...
  if (state->compiling_list)
    {
      void_int vv[1];
      vv[0].i = bit;
      list_push ("glEnable", (list_fn_cb) &glEnable, PROTO_I, vv);
    }
  else
    {
  ...
  if (state->compiling_list)
    {
      void_int vv[1];
      vv[0].i = bit;
      list_push ("glDisable", (list_fn_cb) &glDisable, PROTO_I, vv);
    }
  else
    {
      /* We implement 1D textures as 2D textures. */
 ...
 */
void
glVertexPointer (GLuint size, GLuint type, GLuint stride, 
                         const GLvoid *ptr)
{
  if (! state->replaying_list)
...
void
glNormalPointer (GLuint type, GLuint stride, const GLvoid *ptr)
{
  if (! state->replaying_list)
...
void
glColorPointer (GLuint size, GLuint type, GLuint stride, 
                        const GLvoid *ptr)
{
  if (! state->replaying_list)
...
void
glTexCoordPointer (GLuint size, GLuint type, GLuint stride, 
                           const GLvoid *ptr)
{
  if (! state->replaying_list)
...
void
glBindBuffer (GLuint target, GLuint buffer)
{
  if (! state->replaying_list)
...
void
glTexParameterf (GLuint target, GLuint pname, GLfloat param)
{
  Assert (!state->compiling_verts,
  ...
  if (state->compiling_list)
    {
      ...
      vv[1].i = pname;
      vv[2].f = param;
      list_push ("glTexParameterf", (list_fn_cb) &glTexParameterf,
                 PROTO_IIF, vv);
    }
  else
    {
...
void
glTexParameteri (GLuint target, GLuint pname, GLuint param)
{
...
void
glBindTexture (GLuint target, GLuint texture)
{
  Assert (!state->compiling_verts,
  ...
  if (state->compiling_list)
    {
      ...
      vv[0].i = target;
      vv[1].i = texture;
      list_push ("glBindTexture", (list_fn_cb) &glBindTexture,
                 PROTO_II, vv);
    }
  else
    {
